...
const FAQList = ({ toggleDarkMode, isDarkMode }) => {
  ...
  return (
    <div className='max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
      ...
      mb-8 gap-4'>
        <h2 className='text-3xl font-bold bg-gradient-to-r from-indigo-600 
        via-purple-600 t0-pink-600 text-transparent bg-clip-text text-center sm:text-left w-full sm:w-auto'>
        ...
        <div className='flex items-center space-x-4'>
          ...
          focus-visible:ring-2 focus-visible:ring-blue-500 transition-all
          duration-300 cursor-pointer dark:from-gray-700 dark:to-gray-800 dark:text-gray-300
